...
Route::get('/posts/create', [PostsController::class, 'create'])->name('posts.create')->middleware('check_login');
Route::post('/posts/store', [PostsController::class, 'store'])->name('posts.store')->middleware('check_login');
Route::get('/posts/edit/{id}', [PostsController::class, 'edit'])->name('posts.edit')->middleware('check_login');
Route::post('/posts/update/{id}', [PostsController::class, 'update'])->name('posts.update')->middleware('check_login');
Route::get('/posts/destroy/{id}', [PostsController::class, 'destroy'])->name('posts.destroy')->middleware('check_login');
Route::delete('/posts/delete-multiple', [PostsController::class, 'deleteMultiple'])->name('posts.deleteMultiple')->middleware('check_login');
...
Route::get('/categories/create', [CategoryController::class, 'create'])->name('categories.create')->middleware('check_login');
Route::post('/categories/store', [CategoryController::class, 'store'])->name('categories.store')->middleware('check_login');
Route::get('/categories/edit/{id}', [CategoryController::class, 'edit'])->name('categories.edit')->middleware('check_login');
Route::post('/categories/update/{id}', [CategoryController::class, 'update'])->name('categories.update')->middleware('check_login');
Route::get('/categories/destroy/{id}', [CategoryController::class, 'destroy'])->name('categories.destroy')->middleware('check_login');
Route::delete('/categories/delete-multiple', [CategoryController::class, 'deleteMultiple'])->name('categories.deleteMultiple')->middleware('check_login');
